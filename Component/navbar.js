function navbar() {
    ...
    <a style="margin-left: 27px;cursor:pointer;" href="../HTML/home.html" class="logo"><img src="https://images.newindianexpress.com/uploads/user/imagelibrary/2021/1/30/w1200X800/myntra.JPG" alt="myntra logo"></a>
  <nav>
    <ul class="menu-items">
      <li>
        <a href="#" class="menu-item-1">MEN</a>
        <div class="mega-menu">
          <div class="content">
            <div class="col">
              <section>
      ...
      <li>
        <a href="#" class="menu-item-2">WOMEN</a>
        <div class="mega-menu">
          <div class="content">
            <div class="col">
              <section>
      ...
      <li>
        <a href="#" class="menu-item-3">KIDS</a>
        <div class="mega-menu">
          <div class="content">
            <div class="col">
              <section>
    ...
    <a href="">
     ...
     <div class="dropdown">
      ...
      <div class="dropdown-content">
        ...
        <button class="btn-redirect"> <a href="#" class="login-btn">LOGIN / SIGNUP</a> </button>
        <hr class="hr1">
